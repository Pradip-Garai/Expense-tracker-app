...
import { Plus, Edit, Trash2, Target, CheckCircle2, Landmark } from 'lucide-react';
        ...
        <Card className="bg-primary/5 border-primary/20">
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              <div>
                <p className="text-3xl font-bold text-primary">{formatCurrency(fdBalance)}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
              {loading ? (
                ...
                activeGoals.map((goal) => {
                  // Use FD balance as saved amount
                  const savedAmount = fdBalance;
                  const progress = goal.target_amount > 0 ? (savedAmount / Number(goal.target_amount)) * 100 : 0;
